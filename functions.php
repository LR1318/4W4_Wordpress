...
/***********************************************Modification des choix menu cours */
...
function enregistrer_sidebar() {
    register_sidebar( array(
        'name' => __( 'Footer', '4w4_Luca_Ruggeri' ),
        'id' => 'footer',
        'description' => __( 'Un widget area pour afficher des widgets dans la footer.', '4w4_Luca_Ruggeri' ),
    ...
    register_sidebar( array(
        'name' => __( 'widget2', '4w4_Luca_Ruggeri' ),
        'id' => 'widget2',
